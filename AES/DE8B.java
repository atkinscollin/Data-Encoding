...
// DE8B.java CS6025 Cheng 2016
// Implementing AES decryption
// Usage: java DE8B key < encrypted.de8 > original
...
public class DE8B{
 ...
 void inverseShiftRows(){
     /*System.out.printf("\n3: %s   ", state[3]);
     System.out.printf("7: %s   ", state[7]);
     System.out.printf("11: %s   ", state[11]);
...
public static void main(String[] args){
   if (args.length < 1){
     System.err.println("Usage: java DE8B key < encrypted.de8 > original");
     return;
   }
   DE8B de8 = new DE8B();
   de8.makeLog();
