// DE8D.java CS6025 Cheng 2016
// AES encryption on plaintext 0123456789abcdeffedcba9876543210
// Usage: java DE8D key
...
public class DE8D{
  ...
  static String plaintext = "0123456789abcdeffedcba9876543210";
  static String plaintext2 = "000102030405060708090a0b0c0d0e0f";
 ...
 void initialState(){
   for (int k = 0; k < blockSize; k++) state[k] = 
     Integer.parseInt(plaintext2.substring(k * 2, (k + 1) * 2), 16);
   displayState();
 }
...
System.out.println("Round " + i);
 ...
 void displayState(){
     for (int k = 0; k < blockSize; k++)
        System.out.print(Integer.toString(state[k], 16) + " ");
     System.out.println();   
 }
...
public static void main(String[] args){
   if (args.length < 1){
     System.err.println("Usage: java DE8D key");
     return;
   }
   DE8D de8 = new DE8D();
   de8.makeLog();
