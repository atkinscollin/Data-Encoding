...
// DE16B.java CS6025 Cheng 2016
// inverse wavelet transform of a BMP image
// Usage: java DE16B < lenawave.bmp > lenaRGB.bmp
...
public class DE16B{
 ...
 void reverseRowTransform(){
	 ...
	 for (int i = 0; i < height; i++) {
	     ...
	     raw[i][width - 1][k] = coeffs[i][width - 1][k]
		 + raw[i][width - 2][k];
 ...
 void reverseColumnTransform(){
	 ...
	 for (int j = 0; j < width; j++) {
	     ...
	     coeffs[height - 1][j][k] = raw[height - 1][j][k]
		 + coeffs[height - 2][j][k];
 ...
 public static void main(String[] args){
  ...
  de16.readImage();
  de16.unshrink();
  de16.reverseColumnTransform();
  de16.reverseRowTransform();
  de16.dumpRaw();
 }
}
