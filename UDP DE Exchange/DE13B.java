// DE13B.java CS6025 Cheng 2016
// A UDP client talking with DE13A 
...
// Usage: java DE13B serverIP/hostname serverPort
...
public class DE13B{
 ...
 public static void main(String[] args){
   if (args.length < 2){
     System.err.println("Usage: java DE13B serverIP serverPort");
     System.exit(1);
   }
   DE13B de13 = new DE13B();
   de13.readQ("DHgroup5.txt");
   de13.generateKeyPair();
   de13.runUDPClient(args[0], Integer.parseInt(args[1]));
   de13.computeSharedSecret();
 }
}
