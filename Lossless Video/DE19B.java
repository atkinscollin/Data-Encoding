// DE19B.java CS6025 Cheng 2016
// decoding and viewing compressed CIF 352x288 200 frames
// Usage: java DE19B compressedVideo [pause in ms between frames]
...
public class DE19B extends JFrame{
  ...
  public void playback(){
   ...
   public static void main(String[] args){
      if (args.length < 1){
         ...
         System.out.println("Usage: java DE19B compressedVideo");
   
         System.exit(0);
      }
      
      DE19B de19 = new DE19B(args[0]); 
      if (args.length > 1) de19.pause = Integer.parseInt(args[1]);
      de19.readCompressedData();
      de19.decompress();
      de19.playback();
   }
}
