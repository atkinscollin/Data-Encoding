...
public class DE15B{
   ...
   void verifyStep5(){  // checking the result of encodingStep7
     ...
     for (int i = 0; i < diff; i++){
        if ((DB[0] & singleBit) != 0){ 
          System.err.println("Inconsistent: DB leftmost non-zero");
          System.exit(1);
        }
        singleBit >>= 1;
     }
     System.out.println("Consistent: DB leftmost zero");
   }
   ...
   void verifyStep9(){  // checking padding2, or part of encodingStep4
     ...
     if (DB[border] != 1) {
	 System.err.println("Inconsistent: DB end not 1, padding2");
	 System.exit(1);
     }
     System.out.println("Consistent: DB, padding2");
   }
   ...
   void verifyStep11(){  // part of encodingStep2, fill padding1
       // salt already created in step 10
   ...
   void verifyStep13(){ // compare H with H2 or simply print them out
     ...
     if (i < hLen) System.out.println("Inconsistent: H");
 ...
 public static void main(String[] args){
   if (args.length < 2){
     System.out.println("Usage: java DE15B publicKey signature < message");
     return;
   }
