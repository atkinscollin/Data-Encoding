// DE15A.java CS6025 Cheng 2016
// RSA-PSS encoding 
// Usage:  java DE15A privateKey < message > signature
...
public class DE15A{
 ...
 public static void main(String[] args){
   if (args.length < 1){
     System.out.println("Usage: java DE15A privateKey < message > signature");
     return;
   }
   DE15A de15 = new DE15A();
   de15.readPrivateKey(args[0]);
   de15.sign();
   de15.printSignature();
 }
}
